      ...
      <div className="flex flex-col md:flex-row flex-wrap justify-between ">
        ...
        <div>
          ...
          <div className="mt-[24px] flex space-x-[10px]">
            ...
            <input
              ...
              autoComplete="email"
              className="flex-auto rounded-md bg-white/5 md:px-[14px] py-[8px] text-[16px] text-white placeholder:pl-3 placeholder:text-gray-500 outline-1 outline-white/10 focus:outline-2 focus:outline-offset-[-2px] focus:outline-indigo-500"
            />
            <button
              type="submit"
        ...
        <div className="flex flex-col min-[600px]:flex-row max-[992px]:mt-[24px] space-x-[24px] space-y-[17px]">
          ...
          <div className="flex flex-col text-white min-w-[160px]">
            ...
            <ul className="mt-[16px] space-y-[8px] text-[14px]">
              <li>
                <Link href="#">Cancelled Concerts</Link>
              </li>
              <li>
                <Link href="#">Cancellation Insurance</Link>
              </li>
              <li>
                <Link href="#">Rescheduled Events</Link>
              </li>
            </ul>
          </div>
