  ...
  return (
    <div className="">
      <div className="flex flex-col space-y-[16px]">
        ...
        <p className="text-[24px] text-neutral-600 font-semibold">
          A Night to Remember!
        </p>
      ...
      <Link href={"/tickets"}>
        <button className="mt-[48px] bg-primary-500 hover:bg-blue-700 text-white font-bold px-[48px] py-[20px] rounded-2xl cursor-pointer">
          Get Ticket
        </button>
      </Link>
    </div>
